...
void FlockController::addParticle( int numParticles ){
    for( int i=0; i<numParticles; i++ ){
		...
		ofVec2f pos = randVec * ofRandom( 0.0f, 800.0f );
		ofVec2f vel = -randVec*5;
...
void FlockController::applyForces(ofVec2f faceCenter, float zoneRadius, float separateThresh, float alignThresh) {
